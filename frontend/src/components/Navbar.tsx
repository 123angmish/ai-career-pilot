...
import { LogOut, User as UserIcon, Bell, Sparkles, FileText, Link2, Award, MessageSquare, Globe, Search, Command, Settings } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="h-16 border-b border-slate-200 bg-white/80 backdrop-blur-xl px-6 flex items-center justify-between sticky top-0 z-30 select-none shadow-xs">
      ...
      <div className="hidden md:flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-100/80 border border-slate-200 text-xs text-slate-500 hover:bg-slate-100 hover:border-slate-300 transition-all cursor-pointer w-64 shadow-xs">
      ...
      <div className="flex items-center space-x-3">
        ...
        <Dropdown>
          <DropdownTrigger>
            <button className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-xs transition-all border border-indigo-100 shadow-xs">
        ...
        <div className="relative">
          <button className="p-2 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-600 hover:text-slate-900 transition-all shadow-2xs">
